-- Migration 061: Ensure payroll tables exist (idempotent re-run of 053)
...
CREATE INDEX IF NOT EXISTS idx_salary_assignments_tenant ON staff_salary_assignments(tenant_id);
