/**
 * Seeds default chart_of_accounts and finance_settings for a new tenant.
 * Called when a new school registers to ensure the finance module works out of the box.
 */
import { query } from '../config/database.js';

export async function seedFinanceDataForTenant(tenantId) {
  // Chart of Accounts — standard Kenyan school accounts
  await query(`
