...
const DOCS = [
  {
    ...
    color: 'blue',
    articles: [
      { title: 'How to register your school', content: 'Go to the landing page and click "Register Your School". Fill in your school name, county, phone, admin email and password, then click Register. Your 5-day free trial begins immediately — no payment needed to start.\n\nAfter registration, log in with the admin email and password you provided. You will land on the Admin Dashboard where you can begin setting up your school data.' },
