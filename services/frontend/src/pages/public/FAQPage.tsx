...
const FAQS = [
  {
    ...
    items: [
      ...
      { q: 'How do I pay?', a: 'Registration is via M-Pesa STK Push, prompted directly on the registration page: pay the KSh 50,000 deposit first, then clear the KSh 50,000 balance within 5 days from Settings → Billing once your account is approved. You can also pay directly to Paybill 522533, Account 8071524, then call or WhatsApp us on 0110 421 320 or 0703445756, or email info@helvino.org with your school name and M-Pesa code — we\'ll confirm the payment and approve your account.' },
