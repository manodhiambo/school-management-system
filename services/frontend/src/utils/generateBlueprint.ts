...
const MODULES: ModuleData[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'CBE assessments visible on student/parent dashboards', 'Broadsheet & analytics dashboards',
      'IGCSE Cambridge parallel module',
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      'Fee structure per class/term',              'Per-term fee amounts (e.g. Term 1 ≠ Term 3)',
      'Smart bulk invoice generation',
  ...
  },
  {
    ...
    description: 'Visual weekly timetable creation and management for all classes, with one-click automatic generation, print and PDF download for posting on notice boards.',
    features: [
      'Auto-generate full weekly timetable',        'Auto-assigns subjects, teachers & time slots',
      'Clash-free scheduling (teacher & class)',    'Configurable periods/day, length & breaks',
      ...
      'Parent view of each child\'s timetable',      'Teacher personal timetable view',
      'Live "now teaching" & upcoming-period alert', 'SMS class-time reminders for teachers',
      'Print timetable (wall-ready)',                'Download landscape PDF',
      'Reset class or teacher timetable',
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      'Public per-school application form',             'Direct document upload (photo/PDF, no links needed)',
      'Shareable per-school application link',           'Application tracking by phone/email',
      'Document verification workflow',                 'M-Pesa application fee (STK push)',
      'Interview scheduling & outcome notes',            'Offer / reject decision with notes',
      'One-click enrollment into Students',              'Walk-in / phoned-in application entry by staff',
  ...
  },
  {
    ...
    features: [
      ...
      'Office-posted job board (on behalf of partners)',   'Financial, equipment, scholarship & building donations',
      'M-Pesa STK push for cash donations',                'Office-recorded donations (phoned-in/received gifts)',
